        ...
        <div class="col-md-4 pt-5">
            <div class="card shadow border-0 h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="p-1">
                        <h6 class="text-uppercase text-muted small fw-bold mb-0">Progetti</h6>
        ...
        <div class="col-md-4 pt-5">
            <div class="card shadow border-0 h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="p-1">
                        <h6 class="text-uppercase text-muted small fw-bold mb-0">Tipologie</h6>
        ...
        <div class="col-md-4 pt-5">
            <div class="card shadow border-0 h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="p-1">
                        <h6 class="text-uppercase text-muted small fw-bold mb-0">Tecnologie</h6>
